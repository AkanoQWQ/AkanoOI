...
//	vector<pii> edges;
//	for(int u = 1;u <= nnt;u++){
////		cout<<u<<" bel "<<bel[u]<<" size "<<sz[bel[u]]<<endl;
//		for(int i = head[u];i;i = e[i].nxt){
//			const int v = e[i].to;
////			cout<<u<<" ORG-> "<<v<<endl;
...
//			const int u = no[i];
//			if(nameX[p[i].first] != 0){
//				const int v = no[nameX[p[i].first]];
//				AddEdge(v,u);
//			}
//			if(nameY[p[i].second] != 0){
//				const int v = no[nameY[p[i].second]];
//				AddEdge(v,u);
//			}
//			for(auto vpre : to[i]){
//				const int v = no[vpre];
...
//		if(door[i] != 2){
//			if(nameY[p[i].second] != 0){
//				const int yfa = GetFa(nameY[p[i].second]);
//				const int yno = no[yfa];
//				AddEdge(yno,no[i]);
//			}
//		}
//		if(door[i] != 1){
//			if(nameX[p[i].first] != 0){
//				const int xfa = GetFa(nameX[p[i].first]);
//				const int xno = no[xfa];
//				AddEdge(xno,no[i]);
//			}
//		}
//	}
